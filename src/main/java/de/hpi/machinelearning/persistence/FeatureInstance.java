...
public class FeatureInstance extends DenseInstance {
    ...
    public FeatureInstance(@NotNull ShopOffer shopOffer, @NotNull ParsedOffer parsedOffer, @NotNull Boolean isMatch, String classifiedBrand, String classifiedCategory) {
        super(11);
        ...
        this.setValue(features.get(8), getEquation(shopOffer.getMappedCatalogCategory(), classifiedCategory));
